...
거버넌스 공백이 즉각적인 보안 위협으로 이어지고 있다. 조사 대상 기업의 45%가 미인가 생성 AI 도구 사용으로 인한 민감 정보 유출을 확인하거나 의심하고 있으며, 39%는 독점 지식재산 유출을 보고했다.
...
AI 투자의 경제적 영향이 극도로 편중되어 있다는 신호다. S&P 500 기업의 70%가 분기 실적 발표에서 AI를 언급했으나 구체적 ROI를 정량화한 기업은 10%에 불과했고, 순이익에 미친 영향을 추정한 기업은 단 1%에 그쳤다.
...
AI 에이전트가 이제 "거의 준비됐다"는 가설에서 "배포 병목이 기술이 아닌 조직 변화"라는 현실로 전환되었다. 골드만삭스는 거래 조정(transaction reconciliation)에 자율 에이전트를 배포해 근본 원인 파악을 4시간에서 수 분으로 단축했고, 세일즈포스는 전체 지원 조직을 에이전트 중심으로 재구성했다.
