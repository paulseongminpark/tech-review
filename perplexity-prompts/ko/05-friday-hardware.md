...
- Tom's Hardware, AnandTech, ServeTheHome
- SemiAnalysis, The Register, EE Times
- Reuters Technology, Bloomberg Technology
- Reddit: r/hardware, r/nvidia, r/AMD, r/chipdesign
- Hacker News (top stories)
- Company newsrooms: NVIDIA, AMD, Intel, TSMC, AWS, Google Cloud, Azure

{KEYWORDS_BLOCK}

위 소스에서 AI 하드웨어·칩·데이터센터·클라우드 인프라 관련 가장 중요한 뉴스 3건을 아래 형식으로 한국어 작성.
